...
from agent_004 import MahjongAgent
from helpers import (
...
class MahjongAgentExecutor(BaseAgentExecutor):
    ...
    async def on_message_stream(
        ...
        params: MessageSendParams = request.params
        query = self._get_user_query(params)
        player_id = int(self._get_param(params, 'player_id', 4))
        persona = self._get_param(params, 'persona', '周翊，允棠的男性朋友，大学同班同学，20岁，性格温和，做事认真负责，对允棠有好感，但还没有表白。')
