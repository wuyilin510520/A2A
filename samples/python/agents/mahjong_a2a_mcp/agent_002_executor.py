...
from agent_002 import MahjongAgent
from helpers import (
...
class MahjongAgentExecutor(BaseAgentExecutor):
    ...
    async def on_message_stream(
        ...
        params: MessageSendParams = request.params
        query = self._get_user_query(params)
        player_id = int(self._get_param(params, 'player_id', 2))
        persona = self._get_param(params, 'persona', '景彦，允乐的男朋友，男生，25岁，性格谨慎保守，做事稳重，说话风格温和有礼，为人踏实可靠。')
