...
from agent_003 import MahjongAgent
from helpers import (
...
class MahjongAgentExecutor(BaseAgentExecutor):
    ...
    async def on_message_stream(
        ...
        params: MessageSendParams = request.params
        query = self._get_user_query(params)
        player_id = int(self._get_param(params, 'player_id', 3))
        persona = self._get_param(params, 'persona', '允棠，允乐的妹妹，女生，20岁，大二在读，性格活泼开朗，说话风格亲切自然，对哥哥的男朋友景彦有好感。')
